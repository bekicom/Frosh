        ...
        <div className="register-card">
            ...
            <div className="reg-card-register">
                ...
                <form action="">
                    ...
                    <span>Hisobingiz bormi? <button type='button' onClick={() => setIslogin(true)}>Hisobga kirish</button></span>

                    <button type='button' onClick={() => setSms(true)}  >Sms kod yuborish</button>
        ...
        {sms &&
            <div className="modal"  >
                <div className="modal-card">
                    ...
                    />
                    <span>00:59</span>
                    <span>Kod kelmadimi? <button  >Qayta yuborish</button></span>
                ...
                <div className="truecart">
                    {
                        truemodal ?
                            <>
                                ...
                                <p>Siz muvaffaqiyatli
                                    ro’yxatdan o’tdingiz!</p>
